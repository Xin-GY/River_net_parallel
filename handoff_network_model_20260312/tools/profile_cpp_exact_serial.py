...
def main() -> int:
    ...
    parser.add_argument("--use-cpp-nodechain-refresh-deep", action="store_true", default=False)
    ...
    os.environ["ISLAM_CPP_USE_NODECHAIN_REFRESH_DEEP"] = "1" if args.use_cpp_nodechain_refresh_deep else "0"
    ...
    summary = {
        ...
        "use_cpp_nodechain_refresh_deep": bool(args.use_cpp_nodechain_refresh_deep),
